...
import Tarjetafiltrada from "../components/Tarjetafiltrada";
    ...
    return (
        <section className={style.seccionConFondo}>
            ...
            <div>
                ...
                <Link className="link"  to="/ReactApp/" style={{padding: '5px 30px', backgroundColor: '#4e6e52', color: 'white', textDecoration: 'none', borderRadius: '0 10px 10px 0', boxShadow: 'inset 0 0 5px black'}}>
                    Volver
                </Link>
                <ul className={style.lista}>
                    {filteredMonsters.map((monster) => (
                        <Tarjetafiltrada key={monster._id["$oid"]} monster={monster} />
                    ))}
                </ul>
            </div>
        </section>
